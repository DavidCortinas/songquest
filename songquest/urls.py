...
urlpatterns = [
     ...
     path('update-display-name/',
          views.update_display_name, name='update-display-name'),
     path('update-birthday/',
          views.update_birthday, name='update-birthday'),
     path('update-preferred-genres/',
          views.update_preferred_genres, name='update-preferred-genres'),
     path('update-user-type/',
          views.update_user_type, name='update-user-type'),
     path('update-user-profession/',
     ...
     path('update-playlist-items/<str:playlist_id>/',
          views.update_playlist_items, name='update-playlist-items'),
     ...
     path('user-follows-artists/', views.check_if_user_follows_artists, name='user-follows-artist'),
