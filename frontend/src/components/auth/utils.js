...
export const withAuthForParamsThunk = thunk => {
	return (params, accessToken, refreshToken, ...args) =>
...
export const withAuthForSimpleThunk = thunk => {
...
export const withAuthForDispatchThunk = thunk => {
	return (accessToken, refreshToken, ...args) =>
		async dispatch => {
			const executeThunk = async currentAccessToken => {
